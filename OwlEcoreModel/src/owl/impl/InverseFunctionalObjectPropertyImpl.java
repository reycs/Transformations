...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Inverse Functional Object Property</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link owl.impl.InverseFunctionalObjectPropertyImpl#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InverseFunctionalObjectPropertyImpl extends ObjectPropertyAxiomImpl implements InverseFunctionalObjectProperty {
	/**
	 ...
	 * @generated
	 */
	protected InverseFunctionalObjectPropertyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return OwlPackage.Literals.INVERSE_FUNCTIONAL_OBJECT_PROPERTY;
	}
		...
		if (objectPropertyExpression != null && objectPropertyExpression.eIsProxy()) {
			...
			if (objectPropertyExpression != oldObjectPropertyExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.INVERSE_FUNCTIONAL_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
			}
		}
	...
	public void setObjectPropertyExpression(ObjectPropertyExpression newObjectPropertyExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.INVERSE_FUNCTIONAL_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OwlPackage.INVERSE_FUNCTIONAL_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION:
...
} //InverseFunctionalObjectPropertyImpl
