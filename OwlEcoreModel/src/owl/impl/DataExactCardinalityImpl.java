 ...
 * </p>
 * <ul>
 *   <li>{@link owl.impl.DataExactCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link owl.impl.DataExactCardinalityImpl#getDataRange <em>Data Range</em>}</li>
 *   <li>{@link owl.impl.DataExactCardinalityImpl#getDataPropertyExpression <em>Data Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataExactCardinalityImpl extends ClassExpressionImpl implements DataExactCardinality {
	...
	public DataPropertyExpression getDataPropertyExpression() {
		if (dataPropertyExpression != null && dataPropertyExpression.eIsProxy()) {
			...
			if (dataPropertyExpression != oldDataPropertyExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.DATA_EXACT_CARDINALITY__DATA_PROPERTY_EXPRESSION, oldDataPropertyExpression, dataPropertyExpression));
			}
		}
	...
	public void setDataPropertyExpression(DataPropertyExpression newDataPropertyExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.DATA_EXACT_CARDINALITY__DATA_PROPERTY_EXPRESSION, oldDataPropertyExpression, dataPropertyExpression));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 OwlValidator.DATA_EXACT_CARDINALITY__THECARDINALITYMUSTBENONNEGATIVE,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OwlPackage.DATA_EXACT_CARDINALITY___THECARDINALITYMUSTBENONNEGATIVE__DIAGNOSTICCHAIN_MAP:
