 ...
 * </p>
 * <ul>
 *   <li>{@link owl.impl.FunctionalObjectPropertyImpl#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionalObjectPropertyImpl extends ObjectPropertyAxiomImpl implements FunctionalObjectProperty {
		...
		if (objectPropertyExpression != null && objectPropertyExpression.eIsProxy()) {
			...
			if (objectPropertyExpression != oldObjectPropertyExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.FUNCTIONAL_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
			}
		}
	...
	public void setObjectPropertyExpression(ObjectPropertyExpression newObjectPropertyExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.FUNCTIONAL_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
	}
