 ...
 * </p>
 * <ul>
 *   <li>{@link owl.impl.ObjectMinCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link owl.impl.ObjectMinCardinalityImpl#getClassExpression <em>Class Expression</em>}</li>
 *   <li>{@link owl.impl.ObjectMinCardinalityImpl#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectMinCardinalityImpl extends ClassExpressionImpl implements ObjectMinCardinality {
	...
	public ClassExpression getClassExpression() {
		if (classExpression != null && classExpression.eIsProxy()) {
			...
			if (classExpression != oldClassExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.OBJECT_MIN_CARDINALITY__CLASS_EXPRESSION, oldClassExpression, classExpression));
			}
		}
	...
	public void setClassExpression(ClassExpression newClassExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.OBJECT_MIN_CARDINALITY__CLASS_EXPRESSION, oldClassExpression, classExpression));
	}
	...
	public ObjectPropertyExpression getObjectPropertyExpression() {
		if (objectPropertyExpression != null && objectPropertyExpression.eIsProxy()) {
			...
			if (objectPropertyExpression != oldObjectPropertyExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.OBJECT_MIN_CARDINALITY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
			}
		}
	...
	public void setObjectPropertyExpression(ObjectPropertyExpression newObjectPropertyExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.OBJECT_MIN_CARDINALITY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 OwlValidator.OBJECT_MIN_CARDINALITY__THECARDINALITYMUSTBENONNEGATIVE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OwlPackage.OBJECT_MIN_CARDINALITY__CLASS_EXPRESSION:
				if (resolve) return getClassExpression();
				return basicGetClassExpression();
			case OwlPackage.OBJECT_MIN_CARDINALITY__OBJECT_PROPERTY_EXPRESSION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OwlPackage.OBJECT_MIN_CARDINALITY___THECARDINALITYMUSTBENONNEGATIVE__DIAGNOSTICCHAIN_MAP:
				return Thecardinalitymustbenonnegative((DiagnosticChain)arguments.get(0), (Map)arguments.get(1));
		}
