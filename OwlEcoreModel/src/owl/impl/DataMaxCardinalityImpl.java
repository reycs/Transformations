 ...
 * </p>
 * <ul>
 *   <li>{@link owl.impl.DataMaxCardinalityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link owl.impl.DataMaxCardinalityImpl#getDataRange <em>Data Range</em>}</li>
 *   <li>{@link owl.impl.DataMaxCardinalityImpl#getDataPropertyExpression <em>Data Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataMaxCardinalityImpl extends ClassExpressionImpl implements DataMaxCardinality {
	...
	public DataRange getDataRange() {
		if (dataRange != null && dataRange.eIsProxy()) {
			...
			if (dataRange != oldDataRange) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.DATA_MAX_CARDINALITY__DATA_RANGE, oldDataRange, dataRange));
			}
		}
		return dataRange;
	}
	...
	public void setDataRange(DataRange newDataRange) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.DATA_MAX_CARDINALITY__DATA_RANGE, oldDataRange, dataRange));
	}
	...
	public DataPropertyExpression getDataPropertyExpression() {
		if (dataPropertyExpression != null && dataPropertyExpression.eIsProxy()) {
			...
			if (dataPropertyExpression != oldDataPropertyExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.DATA_MAX_CARDINALITY__DATA_PROPERTY_EXPRESSION, oldDataPropertyExpression, dataPropertyExpression));
			}
		}
	...
	public void setDataPropertyExpression(DataPropertyExpression newDataPropertyExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.DATA_MAX_CARDINALITY__DATA_PROPERTY_EXPRESSION, oldDataPropertyExpression, dataPropertyExpression));
	}
				...
				diagnostics.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 OwlValidator.DATA_MAX_CARDINALITY__THECARDINALITYMUSTBENONNEGATIVE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OwlPackage.DATA_MAX_CARDINALITY__DATA_RANGE:
				if (resolve) return getDataRange();
				return basicGetDataRange();
			case OwlPackage.DATA_MAX_CARDINALITY__DATA_PROPERTY_EXPRESSION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case OwlPackage.DATA_MAX_CARDINALITY___THECARDINALITYMUSTBENONNEGATIVE__DIAGNOSTICCHAIN_MAP:
