 ...
 * </p>
 * <ul>
 *   <li>{@link owl.impl.IrreflexiveObjectPropertyImpl#getObjectPropertyExpression <em>Object Property Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IrreflexiveObjectPropertyImpl extends ObjectPropertyAxiomImpl implements IrreflexiveObjectProperty {
		...
		if (objectPropertyExpression != null && objectPropertyExpression.eIsProxy()) {
			...
			if (objectPropertyExpression != oldObjectPropertyExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OwlPackage.IRREFLEXIVE_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
			}
		}
	...
	public void setObjectPropertyExpression(ObjectPropertyExpression newObjectPropertyExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OwlPackage.IRREFLEXIVE_OBJECT_PROPERTY__OBJECT_PROPERTY_EXPRESSION, oldObjectPropertyExpression, objectPropertyExpression));
	}
